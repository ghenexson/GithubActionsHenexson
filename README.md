[![Run App Grady Henexson](https://github.com/ghenexson/GithubActionsHenexson/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ghenexson/GithubActionsHenexson/actions/workflows/run-app.yaml)
